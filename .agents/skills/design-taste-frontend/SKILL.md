...
description: Use when designing, building, or redesigning frontend landing pages, portfolios, editorial sites, and marketing experiences that need a distinctive, production-ready visual direction instead of templated AI aesthetics.
---
...
### 12.A File Location
```
blocks/                         # relative to this skill directory
  hero/
    asymmetric-split.md
